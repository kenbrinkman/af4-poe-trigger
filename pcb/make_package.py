...
PARTS = [
    ...
    (["D5"], "LED, yellow, 2.0 V typ", "0805", "SMD", "Kingbright", "APT2012SYC",
     "Lights while the trigger output is asserted."),
    (["F1"], "PPTC resettable fuse, 0.10 A hold / 0.30 A trip, 60 V", "1206", "SMD",
     "Littelfuse", "1206L010/60YR",
     "On the 12 V tap. Feeder supply can source 12.5 A."),
    (["C1"], "Capacitor, 10 uF, 50 V, X7R", "1206", "SMD", "Murata",
     "GRM31CR71H106KA12L", "Regulator input bulk."),
    ...
    (["R2", "R6", "R7"], "Resistor, 10 k, 1%, 1/8 W", "0805", "SMD", "Yageo",
     "RC0805FR-0710KL",
     "R2 = GPIO32 pulldown (boot safety); R6/R7 = LED series resistors."),
    ...
    (["R5"], "Resistor, 887 R, 1%, 1/8 W", "0805", "SMD", "Yageo",
     "RC0805FR-07887RL", "LM1117 divider, ADJ to GND. Vout = 1.25*(1+887/121)."),
