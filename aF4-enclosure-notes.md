...
- **Input wall:** RJ45 snout — the jack face sits 4 mm behind the outer wall plane, so a 1 mm pad on the wall's inner face brings material to 0.1 mm off the jack face, and the tight v1-style window (0.5 mm reveal around the shield) is cut through the resulting 3.9 mm-deep snout. From outside it reads like the v1 flush fit, just slightly recessed. A 12 × 1.8 mm notch below the aperture gives the (downward-facing) plug latch room to flex and be pressed. The jack's latch wings and top shield bump sit in open air behind the snout face — no relief pockets. PG7 gland for the 12V splitter cable, left of the jack; the snout's left edge keeps 1.7 mm clearance to the gland locknut.
