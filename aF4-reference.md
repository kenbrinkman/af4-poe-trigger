...
- `aF4-protoboard-layout.svg` — SSR + R1 (220Ω LED), R2 (10kΩ GPIO pulldown), R3 (2.2kΩ buck preload) placement and wiring on the 25×25 mm protoboard; off-board polyfuse/buck/TVS chain noted in the rev B panel.
